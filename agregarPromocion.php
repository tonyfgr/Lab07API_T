        ...
        <div class="col-4">
            <div class="card">
                <div class="card-header" >
                    Ingresar datos de la promocion para : <br ><strong> <?php echo $usuarios->nombre_completo; ?> </strong>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a onclick="return confirm('la Promocion se  enviara al usuario');" class="text-secondary" href="enviarMensaje.php?codigo=<?php echo $dato->id; ?>"><i class="bi bi-cursor"></i></a></td>
                                </tr>
                            <?php
                            }
                            ?>
